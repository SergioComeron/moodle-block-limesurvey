...
$string['survey_title_formats_by_id'] = 'Survey title formats by ID';
$string['survey_title_formats_by_id_desc'] = 'Custom title formats for specific surveys in JSON format. Each survey ID can have its own format. If a survey is not listed here, the general "Survey title format" will be used. Example: {"123": "{title} - Course: {attribute_12}", "456": "{attribute_9} - {title}", "789": "{title}"}';
$string['startdate'] = 'Start';
$string['expiresdate'] = 'Expires';
$string['surveylist'] = 'Survey list';
$string['completedsurvey_aria'] = 'Submitted survey: {$a}';
$string['pendingsurvey_aria'] = 'Pending survey: {$a}. Opens in new window';
$string['progress_aria'] = 'Survey completion: {$a} percent';
$string['completedstatus'] = 'Submitted';
